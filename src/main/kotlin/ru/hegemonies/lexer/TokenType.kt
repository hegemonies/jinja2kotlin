...
enum class TokenType(val token: String, val grammarName: String) {
    ...
    SIGNED_INTEGER_LITERAL("", "SIGNED_INTEGER_LITERAL"),
    TUPLE_LITERAL("", "TUPLE_LITERAL"),
    LIST_LITERAL("", "LIST_LITERAL"),
    EXPLICIT_TUPLE_LITERAL("", "EXPLICIT_TUPLE_LITERAL"),
//    IMPLICIT_TUPLE_LITERAL("", "IMPLICIT_TUPLE_LITERAL"),
//    TUPLE_LITERAL_CONTENTS("", "TUPLE_LITERAL_CONTENTS"),
//    IMPLICIT_TUPLE_LITERAL("", "IMPLICIT_TUPLE_LITERAL"),
//    IMPLICIT_TUPLE_LITERAL("", "IMPLICIT_TUPLE_LITERAL"),
}
